...
FORBIDDEN_FINANCE_TERMS = (
    ...
    "pension", "retirement fund", "financial", "finance", "investment",
...
AMBIGUOUS_FINANCE_TERMS = {
    ...
    # “stock” can describe paper stock or household supplies.  Treat it as
    # financial only when its nearby wording makes that meaning explicit.
    "stock": ("market", "price", "share", "shares", "portfolio", "dividend", "ticker", "buy", "sell", "trade", "trading", "invest"),
}
