...
# CoWork creates still-image storyboard assets. Video prompts may still exist
# for the opening hook, but image assets are accepted for every scene.
CHARS_PER_SECOND = 5.0
DEFAULT_VIDEO_REQUIRED_UNTIL_SEC = 0
