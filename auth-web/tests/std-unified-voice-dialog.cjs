...
function harness(initialTab,historyUserId){let state=[],refs=[],index=0,ri=0,effects=[],applied=[],closed=0;
...
(async()=>{
 ...
 console.log('PASS: recent confirmed order, persistence, account isolation, corrupt storage; initial provider tabs, single dialog, no automatic API calls, selection/cancel, preview cleanup and explicit sample');
