...
export default function BackgroundAudioWaveform({ locale = 'ko', src, time, timelineDuration, muted, loop = true }: {
    locale?: SupportedLocale; src: string; time: number; timelineDuration: number; muted: boolean; loop?: boolean
}) {
