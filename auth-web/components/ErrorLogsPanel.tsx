...
// 패널. 기존 /api/admin/logs(ai_logs 테이블)를 그대로 재사용한다 - 별도 테이블/파이프라인을
...
// 컬럼이 없어 "누가 어떤 에러를 받았는지" 확인이 불가능했다 - 이 패널이 그 간극을 메운다.
//
// SubscriptionVerificationsPanel 등과 같은 패턴: 실제 UI는 여기 있고,
// app/admin/logs/page.tsx는 이 컴포넌트를 그대로 렌더링하는 얇은 래퍼(직접 URL 접근용),
// DashboardContent.tsx 탭 바에서도 동일 컴포넌트를 인라인으로 띄운다.
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <h2 className="text-lg font-black">에러 로그 조회</h2>
                <button
