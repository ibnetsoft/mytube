...
export default function VoiceStudioPicker({value, direction, onChange, headers, voices = [], historyUserId, microphone = false, label, description, buttonText, buttonClassName}: {
