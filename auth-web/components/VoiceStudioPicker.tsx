...
export default function VoiceStudioPicker({value, direction, onChange, headers, voices = [], historyUserId, microphone = false, label, description, buttonText}: {
    ...
    historyUserId?:string; microphone?:boolean; label?:string; description?:string; buttonText?:string
}) {
    ...
    return <>
        ...
        {open && <UnifiedVoiceDialog historyUserId={historyUserId} value={value} direction={direction} voices={voices} initialTab="google" editDirection
