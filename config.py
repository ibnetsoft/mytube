...
class Config:
    ...
    SCRIPT_GENERATION_PROVIDER = os.getenv("SCRIPT_GENERATION_PROVIDER", "gemini")
    SCRIPT_GENERATION_MODEL = os.getenv("SCRIPT_GENERATION_MODEL", "gemini-2.5-flash")  # 대본 생성 모델
    IMAGE_PROMPT_PROVIDER = os.getenv("IMAGE_PROMPT_PROVIDER", "gemini")
    ...
    def load_remote_keys(cls, keys: dict):
        ...
        valid_keys = {
            ...
            'AI_PROVIDER', 'AI_MODEL', 'SCRIPT_GENERATION_PROVIDER', 'SCRIPT_GENERATION_MODEL',
