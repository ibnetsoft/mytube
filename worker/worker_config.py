...
PROFILE_CHILD_SCRIPTS = {
    "full": ("render_worker", "ae_highlight_worker", "premiere_final_worker", "remote_drive_worker", "hermes_worker", "local_api"),
    "content_only": ("hermes_worker", "local_api"),
    "render_only": ("render_worker", "ae_highlight_worker", "premiere_final_worker", "remote_drive_worker", "local_api"),
}
