...
out=root/'v13';out.mkdir(exist_ok=True)
...
for i,pair in enumerate(lines):
 ...
 for j,eid in enumerate(pair):
  ...
  processed=AudioFileClip(str(dest));starts.append(offset+.12)
  if (i,j)!=(12,1):tracks.append(processed.with_start(clock+offset+.12))
...
import editorial_v13
editorial_v13.install(globals().copy())
leaf=editorial_v13.leaf
