...
html_path = r"C:\Users\kimse\Downloads\YoutubeSourceFinder\LongformGenerator\templates\pages\template.html"
...
for i, script in enumerate(scripts):
    ...
    temp_file_path = os.path.join(temp_dir, f"temp_script_template_{i}.js")
    ...
    try:
        ...
        match = re.search(r'temp_script_template_\d+\.js:(\d+)', e.stderr)
        if match:
